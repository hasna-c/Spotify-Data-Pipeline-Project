...
def album(data):
   ...
   for row in data['items']:
       ...
       album_element = {'album_id': album_id,'album_name': album_name,'album_release_date': album_release_date,
                     'album_total_tracks': album_total_tracks,'album_urls': album_urls
                    }
    ...
    for key, value in row.items():
        if key == "track":
            for artists in value['artists']:
                artist_dict ={'artists_id': artists['id'],'artist_name': artists['name'],'external_url':artists['href']}
...
def lambda_handler(event, context):
   ...
   for data in spotify_data:
       ...
       songs_key = "transformed_data/album_data/songs_transformed_" + str(datetime.now()) + ".csv"
